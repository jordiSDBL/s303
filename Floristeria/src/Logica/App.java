            ...
            switch (menu()) {
                case 1:
                    ...
                    if (floristeria.getNom().equals("")) {
                        String nom = Teclat.llegirString("Quin nom té la Floristeria?\n");
                ...
                case 2:
                    ...
                    double alcada = Teclat.llegirDouble("Alçada:\n");
                    double preu = Teclat.llegirDouble("Preu:\n");
                ...
                case 3:
                    Article flor;
                    System.out.println("**Especificacions**");
                    String color = Teclat.llegirString("Color:\n");
                    preu = Teclat.llegirDouble("Preu:\n");
                    // es crea l'objecte i s'afegeix a l'estoc i al txt
                ...
                case 4:
                    Article deco;
                    System.out.println("**Especificacions**");
                    int material = Teclat.llegirInt("De quin material és la decoració?\n"
                            + "1. Fusta\n"
                            + "2. Plàstic\n");
                    preu = Teclat.llegirDouble("Quin preu té l'article?\n");
                    // es crea l'objecte i s'afegeix a l'estoc i al txt
                    if (material == 1) {
                ...
                case 5:
                    ...
                    break;
                case 6,7,8:
                    String id = Teclat.llegirString("Quin és l'id de l'article a retirar?\n");
                ...
                case 11:
                    ...
                    do {
                        String idArt = Teclat.llegirString("Introdueix l'id de l'article:\n");
                        ...
                        sortir = Teclat.llegirSiNo("Vols afegir més articles? (S/N)\n");
                    } while (sortir);
