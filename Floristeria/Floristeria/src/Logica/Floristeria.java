...
public class Floristeria {
     ...
     * La mida de cada array és la quantitat d'unitats.
     * 
     */
    public void mostraEstocQtt(){
        ...
        System.out.println(categ[0].size() + " unitats.");
        
        System.out.print("FLORS: ");
        System.out.println(categ[1].size() + " unitats.");
        
        System.out.print("DECORACIÓ: ");
        System.out.println(categ[2].size() + " unitats.");
    }
